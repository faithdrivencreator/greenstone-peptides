# Greenstone Wellness — Canonical Content Guide

Source: `bloom.greenstonerx.com/dtp/6a0bb254fa53ddc1571c040b/learn` (the pharmacy's educational portal, branded as GreenstoneWellness.Store).

Scraped 2026-05-18 via Playwright. This is the authoritative voice and information the pharmacy uses; greenstonewellness.store should mirror it (not contradict it).

---

## Brand Posture (overrides previous "research use only" framing)
...
## Treatment Areas (overrides our previous categories)

The pharmacy organizes the formulary as **3 treatment areas → 11 medications**:

1. **Weight Loss** (3 options) — GLP-1 and GIP medications that reset hunger signals — not willpower.
2. **Men's ED** (1 option) — Sildenafil, tadalafil, and combination oral therapies — discreetly shipped.
3. **Peptides** (7 options) — Targeted biological signals for healing, growth hormone, metabolism, and collagen.

Peptides further breaks into 4 sub-areas: **Healing & recovery** · **Growth hormone support** · **Metabolism & cellular energy** · **Collagen & skin**.

---

## Treatment Area: Weight Loss

**Hero:** _GLP-1s changed **what's possible.**_
...
### Medication: Retatrutide (from $277)
...
- **FAQ — Is this approved by the FDA?** Brand-name retatrutide is in late-stage trials, not yet FDA-approved. Compounded retatrutide is dispensed under your provider's prescription using the same active ingredient.

### Medication: Semaglutide (from $54)
...
### Medication: Tirzepatide (from $95)
...
## Treatment Area: Men's ED

**Hero:** _When biology **needs a nudge.**_

**Lead:** Erectile dysfunction is mostly a circulation problem, not a desire problem. Modern oral therapies open up blood flow at the right moment. They don't change libido, they change capability — and that's usually what's actually missing.

**How these work:** PDE5 inhibitors — sildenafil, tadalafil, vardenafil — block an enzyme that breaks down a molecule called cGMP. With cGMP intact, blood vessels in the penis relax and fill predictably during arousal. They don't cause arousal; they let arousal complete its job.

**Sildenafil vs tadalafil:** Sildenafil works in 30–60 minutes and lasts 4–6 hours — best for planned activity. Tadalafil lasts up to 36 hours and can be taken daily at a low dose for ongoing readiness. Both are equivalent in efficacy for most men; the difference is timing.

**Who should wait:** Currently using nitrates for chest pain (combining can drop blood pressure dangerously). Severe heart, liver, or kidney disease. Recent stroke or heart attack. Your provider will review your full history.

### Medication: Oral ED therapies (from $115)

> Sildenafil, tadalafil, vardenafil — discreet pills that work with arousal, not on top of it.

---

## Treatment Area: Peptides

**Hero:** _Short signals. **Real mechanism.**_
...
**How we organize this category:** Peptides come in clusters by mechanism. Healing peptides (BPC-157, TB-500) speed soft-tissue repair. Growth-hormone peptides (Sermorelin, Tesamorelin, CJC-1295, Ipamorelin) signal your pituitary to pulse its own GH. Metabolic peptides (MOTS-c, NAD+) work on mitochondria. Collagen peptides (GHK-Cu) drive structural protein remodeling. Pick the goal first, then the molecule.

### Sub-area: Healing & Recovery

**Hero:** _When the body **is the bottleneck.**_
...
**Medications (summary):**
- **BPC-157** (from $115) — Body Protection Compound — supports tendon, ligament, and gut healing.
- **TB-500** (from $149) — Athletes' staple for soft-tissue recovery and inflammation.

### Sub-area: Growth Hormone Support

**Hero:** _Your pituitary, **recalibrated.**_
...
#### Medication: Tesamorelin (from $115)
...
### Sub-area: Metabolism & Cellular Energy

**Hero:** _Cells run **on signals too.**_
...
### Sub-area: Collagen & Skin

**Hero:** _Repair starts **at the protein.**_
...
1. **Plain, confident, modern**. Not corporate. Not preachy. Not aggressive.
2. **Anti-willpower stance.** Position medications as "what was always missing" — biology, not effort. Phrases used: "reset hunger signals — not willpower", "they change capability".
3. **Two-paragraph headers**: short italicized phrase makes the headline (e.g. _"GLP-1s changed **what's possible.**"_).
4. **Honest about timelines and side effects.** Always state what's normal (e.g., "2-4 days of digestive adjustment, then settles"), what to expect ("Weight loss is not linear — expect plateaus"), and "who should wait" instead of euphemizing.
5. **Doctor + pharmacy framing.** Every dose suggestion ends with: "Suggestions only — your physician reviews and approves the final protocol before any medication ships."
6. **Pricing transparency.** "from $X" attached to every medication summary card.
...
- ❌ Medical-claim hedge language ("may support", "could help") when the pharmacy uses confident descriptive language
- ❌ "Pharmaceutical-grade" puffery — replace with concrete "USP 797 sterile" + "503A pharmacy" + "Licensed in FL"
- ❌ Crude / casual phrasing ("burn fat", "shred", "blast")
- ❌ Before/after testimonials, success stories, dosing protocols pretending to be advice

## Trust Signals to Replicate Across the Site

| Bloom uses | Greenstone Wellness should match |
|---|---|
...
## Next-Action Mapping (Bloom CTA → our analog)

Bloom uses: **Add to cart** (which feeds into phone-verify → intake → prescriber → pay).
Our site is the funnel TO Bloom. Every product card / "buy" button → opens the Bloom DTP URL in a new tab via `<PharmacyButton>`.
