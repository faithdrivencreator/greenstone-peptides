...
export const GOAL_MECHANISMS: Record<GuideGoal, GoalMechanism> = {
  'lose-weight': {
    chain: [
      ...
      { icon: Brain, sublabel: 'Signal', label: 'Brain: "I\'m full"' },
      { icon: TrendingDown, sublabel: 'Outcome', label: 'Sustained fat loss' },
    ],
  ...
  'build-recover': {
    chain: [
      ...
      { icon: Activity, sublabel: 'Action', label: 'New blood vessels' },
      { icon: ShieldCheck, sublabel: 'Outcome', label: 'Faster healing' },
    ],
  ...
  'anti-aging': {
    chain: [
      ...
      { icon: Waves, sublabel: 'Action', label: 'Natural GH release' },
      { icon: Sparkles, sublabel: 'Outcome', label: 'Cellular renewal' },
    ],
  ...
  'energy-metabolism': {
    chain: [
      ...
      { icon: Zap, sublabel: 'Action', label: 'Powers mitochondria' },
      { icon: Sun, sublabel: 'Outcome', label: 'Sustained energy' },
    ],
  ...
  'mens-health': {
    chain: [
      ...
      { icon: HeartPulse, sublabel: 'Action', label: 'Vasodilation' },
      { icon: Flame, sublabel: 'Outcome', label: 'Improved performance' },
    ],
  ...
  'womens-health': {
    chain: [
      ...
      { icon: Sparkles, sublabel: 'Action', label: 'GH restoration' },
      { icon: Moon, sublabel: 'Outcome', label: 'Energy + sleep + skin' },
    ],
