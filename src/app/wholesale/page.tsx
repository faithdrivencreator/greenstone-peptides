...
export const metadata: Metadata = {
  ...
  description:
    'GS Wellness Pharmacy wholesale and distribution program. Partner with us to offer USA-compounded peptides to your clinical network.',
      ...
      <section className="section-py bg-emerald/[0.08] border-b border-emerald/25 relative overflow-hidden">
        ...
        <div className="container-gr relative z-10 max-w-4xl">
          ...
          <p className="mt-8 text-lg text-cream-dim max-w-2xl leading-relaxed">
            GS Wellness Pharmacy offers a structured wholesale program for medspas, integrative
