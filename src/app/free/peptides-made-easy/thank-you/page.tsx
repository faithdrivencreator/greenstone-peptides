...
const PDF_URL = '/downloads/greenstone-peptides-made-easy.pdf';
...
const nextSteps = [
  ...
  },
  {
    ...
    body: 'Match peptides to your goals. A 48-hour research framework plus a quality and sourcing checklist.',
...
export default function PeptidesMadeEasyThankYouPage() {
  return (
    <>
      <LeadCaptureTracker ebook="made-easy" />
